...
public class UserController {
    @Autowired
    com.smbms.service.userMapperService userMapperService;
    @Autowired
    ...
    public String user(@ModelAttribute User user, HttpServletRequest request,
                       @RequestParam(value = "path", required = true) MultipartFile file) throws IOException {
